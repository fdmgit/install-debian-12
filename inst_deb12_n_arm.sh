...
######################################
	...
	cd /root
	wget  https://raw.githubusercontent.com/fdmgit/install-debian-12/main/smartmontools_7.4-2_arm64.deb
	dpkg -i smartmontools_7.4-2_arm64.deb
	rm smartmontools_7.4-2_arm64.deb
...
##############################
	...
	apt install linux-image-6.7.12+bpo-arm64 -y
	apt install linux-headers-6.7.12+bpo-arm64 -y
...
###################################
	...
	cd /usr/local/bin
	wget https://github.com/koki-develop/gat/releases/download/v0.17.0/gat_Linux_arm64.tar.gz
...
###################################
    ...
    tar -vxzf joshuto-v0.9.8-aarch64-unknown-linux-musl.tar.gz -C /usr/local/bin  --strip-components=1
	chown root:root joshuto
	rm joshuto-v0.9.8-aarch64-unknown-linux-gnu.tar.gz
}
